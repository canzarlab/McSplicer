...
def get_args():
    ...
    parser.add_argument('--gene_list', type=str, help='Input file with gene IDs, use this parameter when running McSplicer on multiple genes.', default = '',required=False)
    ...
    parser.add_argument('--bootstraps', type=int, default="1",help='Number of bootstrap steps')
