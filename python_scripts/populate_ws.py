            ...
            for i in range(len(binary_node_list)-1):
                ...
                if type_site == 's':
                    if segment_1==0 and segment_2==0:
                        ...
                        print("Warning: file -> compute_ws.py\n\tIncompatible read: Pair of 1-0 segments are seperated by start site.")    
                ...
                if type_site == 'e':
                    if segment_1==1 and segment_2==1:
                        ...
                        probability = 1e-10
                        print("Warning: file -> compute_ws.py\n\tIncompatible read: Pair of 0-1 segments are seperated by end site.")
